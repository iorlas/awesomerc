...
awful.util.spawn_with_shell("xcompmgr -Ffas &")
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "v",      function (c) c.opacity = c.opacity - 0.03     end),
    awful.key({ modkey, "Shift"   }, "v",      function (c) c.opacity = c.opacity + 0.03     end),
